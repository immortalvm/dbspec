/* This file is based on lib/ai_serenade_treesitter_TreeSitter.cc
   from https://github.com/serenadeai/java-tree-sitter . */

#include "no_nr_dbspec_TreeSitter.h"
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
  ...
  _loadClass(_nodeClass, "no/nr/dbspec/Node");
  ...
  _loadClass(_treeCursorNodeClass, "no/nr/dbspec/TreeCursorNode");
...
Java_no_nr_dbspec_TreeSitter_parserNew(JNIEnv* env, jclass self) {
...
Java_no_nr_dbspec_TreeSitter_treeCursorCurrentFieldName(
...
Java_no_nr_dbspec_TreeSitter_treeCursorCurrentNode(JNIEnv* env,
                                                             jclass self,
                                                             jlong cursor) {
...
JNIEXPORT jobject JNICALL
Java_no_nr_dbspec_TreeSitter_treeCursorCurrentTreeCursorNode(
    JNIEnv* env, jclass self, jlong cursor) {
...
Java_no_nr_dbspec_TreeSitter_treeCursorGotoFirstChild(JNIEnv* env,
                                                                jclass self,
                                                                jlong cursor) {
...
JNIEXPORT jboolean JNICALL
Java_no_nr_dbspec_TreeSitter_treeCursorGotoNextSibling(JNIEnv* env,
                                                                 jclass self,
                                                                 jlong cursor) {
...
JNIEXPORT jboolean JNICALL
Java_no_nr_dbspec_TreeSitter_treeCursorGotoParent(JNIEnv* env,
                                                            jclass self,
                                                            jlong cursor) {
